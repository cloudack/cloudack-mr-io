 ...
 * 
 */
public class RawComparator extends WritableComparator {
	private static final Text.Comparator TEXT_COMPARATOR = new Text.Comparator();

	public RawComparator() {
	...
	static {
		WritableComparator.define(CustomWritable.class, new RawComparator());
	}
}
